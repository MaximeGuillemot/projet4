...
$activationSubject = 'Activation de votre compte - Jean Forteroche';
        ...
        <body>
            <div id="frame">
                ...
                <p>
                    ...
                    <a href="http://localhost/projet4/public/index.php?p=register&amp;log=' . '%LOGIN%' .'&amp;key=' . '%ACTIVATIONKEY%' .'">
                    http://localhost/projet4/public/index.php?p=register&amp;log=' . '%LOGIN%' .'&amp;key=' . '%ACTIVATIONKEY%' . '</a><br><br>
