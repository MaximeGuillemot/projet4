...
if(!empty($siteUrl) && !empty($activationKey))
{
        ...
        <body>
            <div id="frame">
                ...
                <p>
                    ...
                    <a href="$siteUrl/public/index.php?p=activation&key=$activationKey">$siteUrl/public/index.php?p=activation&key=$activationKey</a><br><br>
